...
HD_PWD='C:/Users/linyi/Documents/FPGA/Encryption/Encryption.runs/Ciphertext_RAM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Ciphertext_RAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Ciphertext_RAM.tcl
