...
HD_PWD='C:/Users/linyi/Documents/FPGA/Encryption - Copy/Encryption.runs/Plaintext_ROM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Plaintext_ROM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Plaintext_ROM.tcl
