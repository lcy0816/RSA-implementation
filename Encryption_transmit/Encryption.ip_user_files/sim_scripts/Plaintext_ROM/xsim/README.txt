...
#
# Generated by export_simulation on Tue Mar 26 15:20:04 -0700 2019
#
################################################################################
...
'-reset_run' switch to the './Plaintext_ROM.sh' script.

./Plaintext_ROM.sh -reset_run
...
./Plaintext_ROM.sh -noclean_files

For more information on the script, please type './Plaintext_ROM.sh -help'.
